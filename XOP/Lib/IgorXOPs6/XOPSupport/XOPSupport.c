...
{
	return (int)CallBack2(THREAD_GROUP_PUT_DF, (void*)threadGroupID, dataFolderH);
}
...
{
	*dataFolderHPtr = NULL;
	return (int)CallBack3(THREAD_GROUP_PUT_DF, (void*)threadGroupID, (void*)waitMilliseconds, dataFolderHPtr);
}
